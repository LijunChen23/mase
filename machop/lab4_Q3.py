...
for multiplier_1 in channel_multipliers:
    for multiplier_2 in channel_multipliers:
        pass_config = dict(base_pass_config)

        pass_config["seq_blocks_2"]["config"]["channel_multiplier"] = multiplier_1
        pass_config["seq_blocks_3"]["config"]["channel_multiplier"] = multiplier_1
        pass_config["seq_blocks_4"]["config"]["channel_multiplier1"] = multiplier_1
        pass_config["seq_blocks_4"]["config"]["channel_multiplier2"] = multiplier_2
        pass_config["seq_blocks_5"]["config"]["channel_multiplier"] = multiplier_2
        pass_config["seq_blocks_6"]["config"]["channel_multiplier"] = multiplier_2
